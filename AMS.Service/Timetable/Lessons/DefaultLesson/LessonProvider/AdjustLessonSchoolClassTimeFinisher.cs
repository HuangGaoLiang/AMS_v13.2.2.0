...
namespace AMS.Service
{
    ...
    /// </summary>
    public class AdjustLessonSchoolClassTimeFinisher : AdjustLessonSchoolClassTimeProvider, ILessonFinisher
    {
        private readonly List<TblTimAdjustLesson> _adjustLessonList;   //课次调整信息表信息
        private readonly List<TblTimLesson> _lessonList;    //要销毁的课次

        /// <summary>
        /// 描述：实例化一个全校上课日期调整课次销毁者
        /// <para>作者：瞿琦</para>
        /// <para>创建时间：2019-3-8</para>
        /// </summary>
        /// <param name="adjustLessonList">课次调整信息表信息</param>
        /// <param name="lessonList">要销毁的课次列表</param>
        public AdjustLessonSchoolClassTimeFinisher(List<TblTimAdjustLesson> adjustLessonList, List<TblTimLesson> lessonList)
        {
        ...
        /// 业务类型
        /// </summary>
        public override int BusinessType { get => (int)ProcessBusinessType.F_AdjustLessonSchoolClassTime; set { } }
        ...
        public List<LessonFinisherInfo> GetLessonFinisherInfo()
        {
            ...
            foreach (var item in _lessonList)
            {
                ...
                var lissonEntity = new LessonFinisherInfo
                {
                    ...
                    Remark = LessonProcessConstants.LessonSchoolClassTimeRemark
                };
