...
namespace AMS.Service
{
    ...
    /// </summary>
    public class AdjustLessonClassTimeFinisher : AdjustLessonClassTimeProvider, ILessonFinisher
    {
        ...
        /// <summary>
        /// 描述：实例化一个班级上课时间课次调整销毁者
        /// <para>作者：瞿琦</para>
        /// <para>创建时间：2019-3-8</para>
        /// </summary>
        public AdjustLessonClassTimeFinisher(List<TblTimAdjustLesson> adjustLessonList, List<TblTimLesson> lessonList)
        {
        ...
        /// 业务类型
        /// </summary>
        public override int BusinessType { get => (int)ProcessBusinessType.F_AdjustLessonClassTime;set { } }
        ...
        public List<LessonFinisherInfo> GetLessonFinisherInfo()
        {
            ...
            foreach (var item in _lessonList)
            {
                ...
                var lissonEntity = new LessonFinisherInfo
                {
                    ...
                    Remark = LessonProcessConstants.LessonClassTimeRemark
                };
